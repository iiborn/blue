...
🔺 #lock|unlock tag (قفل ارسال هشتگ/#و@ ها)
...
>- <b>[!/#]/setwlc</b> <code>text</code> <i>(تنظیم پیغام خوش آمد گویی)</i>

-مثال: <b>/setwlc</b> <code>hello :-)</code>


>- <b>[!/#]delwlc</b>  <i>(حذف پیغام خوش آمد گویی تنظیم شده و فعال سازی پیغام خوش آمد گویی پیشفرض)</i>
...
🔺 <b>[!/#]mute all</b> <code>(فعال سازی فیلتر تمامی گفتگو ها)</code>

🔺 <b>[!/#]mute all</b> ثانیه/دقیقه/ساعت <code>(فعال سازی فیلتر تمامی گفتگو ها برای مدت زمان تایین شده توسط شما)</code>
>- <code>(برای مثال اگر میخواهید گروه را برای 1 ساعت قفل کنید به شکل زیر عمل کنید)</code>
🔺 <b>[!/#]mute all 1 0 0</b> --قفل کردن گروه برای مدت زمان 1 ساعت
...
🔺 <b>[!/#]mute all 3 15 9</b> --قفل کردن گروه برای مدت زمان 3 ساعت و 15 دقیقه و 9 ثانیه

🔺 <b>[!/#]unmute all</b> <code>(غیرفعال سازی فیلتر تمامی گفتگو ها)</code>
...
#clean rules (حذف قوانین قبت شده)
#clean modlist (حذف لیست مدیران)
#clean mutelist (حذف لیست کاربران حالت سکوت)
#clean bots (حذف تمامی ربات های سوپرگروه)
#clean deleted (حذف كاربران ديليت اكانت شده)
...
(شما میتوانید از "/" و "#" در اول دستورات استفاده کنید)
 ...
 ℹ️راهنمای فارسی کاربران عادی(blue BOT):
