local function run(msg, matches)
		------fun------
		if matches[1]:lower() == 'id' and not msg.reply_id then
		local user_id = msg.from.id
    local chat_id = get_receiver(msg)
    local token = "285106295:AAHZasHezi01be98DZuWv5-wdhLC42bORVE"
  ...
  local photos = '/home/bot/black/userinfo/ax.png'
  local user_info = {}
...
return reply_msg(msg.id, text, ok_cb, false)
	   ...
	   userrank = "Member"
	if tonumber(msg.from.id) == 251862863 then
		userrank = "Developer ⭐⭐⭐⭐⭐⭐"
